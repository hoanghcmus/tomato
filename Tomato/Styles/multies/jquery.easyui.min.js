...
(function ($) {
    ...
    $.fn.panel.defaults = {
        id: null, title: null, iconCls: null, width: "auto", height: "auto", left: null, top: null, cls: null, headerCls: null, bodyCls: null, style: {}, href: null, cache: true, fit: false, border: true, doSize: true, noheader: false, content: null, collapsible: false, minimizable: false, maximizable: false, closable: false, collapsed: false, minimized: false, maximized: false, closed: false, openAnimation: false, openDuration: 100, closeAnimation: false, closeDuration: 100, tools: null, queryParams: {}, method: "get", href: null, loadingMessage: "Loading...", loader: function (_252, _253, _254) {
            ...
            $.ajax({
                type: opts.method, url: opts.href, cache: false, data: _252, dataType: "html", success: function (data) {
                    _253(data);
                }, error: function () {
...
(function ($) {
    ...
    function _268(_269) {
        ...
        var win = $(_269).panel($.extend({}, _26a.options, {
    ...
    function _26f(_270) {
        ...
        _271.window.draggable({
            handle: ">div.panel-header>div.panel-title", disabled: _271.options.draggable == false, onStartDrag: function (e) {
                if (_271.mask) {
        ...
        _271.window.resizable({
            disabled: _271.options.resizable == false, onStartResize: function (e) {
                if (_271.pmask) {
                    _271.pmask.remove();
                }
...
(function ($) {
    ...
    function _291(_292, _293, _294) {
        ...
        win.window({
            title: _292, noheader: (_292 ? false : true), width: 300, height: "auto", modal: true, collapsible: false, minimizable: false, maximizable: false, resizable: false, onClose: function () {
                setTimeout(function () {
                    win.window("destroy");
                }, 100);
            }
...
(function ($) {
    ...
    function _2c6(_2c7, pp, _2c8) {
        ...
        pp.panel($.extend({}, { collapsible: true, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: true, headerCls: "accordion-header", bodyCls: "accordion-body" }, _2c8, {
            onBeforeExpand: function () {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, multiple: false, selected: 0, onSelect: function (_2f2, _2f3) {
...
(function ($) {
    ...
    function _324(_325, pp, _326) {
        ...
        pp.panel($.extend({}, _326, {
            border: false, noheader: true, closed: true, doSize: false, iconCls: (_326.icon ? _326.icon : undefined), onLoad: function () {
                if (_326.onLoad) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 27, selected: 0, showHeader: true, plain: false, fit: false, border: true, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_369) {
...
(function ($) {
    ...
    function _386(_387, _388, el) {
        ...
        if (pp.panel("options").split) {
            ...
            _38d.resizable($.extend({}, {
                handles: _38e, onStartResize: function (e) {
                    _378 = true;
...
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, validParams: null, delay: 200, missingMessage: "This field is required.", invalidMessage: null, tipPosition: "right", deltaX: 0, novalidate: false, events: {
            focus: _424, blur: _428, mouseenter: _42c, mouseleave: _42f, click: function (e) {
                var t = $(e.data.target);
                if (!t.is(":focus")) {
                    t.trigger("focus");
                }
...
(function ($) {
    ...
    function _46a(_46b) {
        ...
        _46c.validatebox($.extend({}, opts, {
            deltaX: $(_46b).textbox("getTipX"), onBeforeValidate: function () {
                var box = $(this);
                if (!box.is(":focus")) {
...
(function ($) {
    ...
    function load(_4b9, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _4ba, dataType: "json", success: function (data) {
                    _4bb(data);
                }, error: function () {
    ...
    $.fn.form.defaults = {
        novalidate: false, ajax: true, url: null, queryParams: {}, onSubmit: function (_4db) {
...
(function ($) {
    ...
    function _5a6(_5a7) {
        ...
        _5a9.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_5aa, _5ab) {
                setTimeout(function () {
        ...
        if (opts.pagination) {
            ...
            _5ae.pagination({
                total: (opts.pageNumber * opts.pageSize), pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_5af, _5b0) {
    ...
    function _5bb(_5bc) {
        ...
        _5c0.each(function () {
            $(this).resizable({
                handles: _5c3, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _5bd.resizing = true;
    ...
    var _6ca = $.extend({}, _6bc(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function (_6cb, _6cc) {
    ...
    var _713 = {
        render: function (_714, _715, _716) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowStyler: function (_755, _756) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _757, dataType: "json", success: function (data) {
                    _758(data);
                }, error: function () {
            ...
            getTr: function (_75a, _75b, type, _75c) {
                type = type || "body";
                _75c = _75c || 0;
...
(function ($) {
    ...
    function _788(_789) {
        ...
        $(_789).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onClickCell: function (_78b, _78c, _78d) {
                if (_787 != this) {
                    _78e(_787);
                    _787 = this;
                }
    ...
    var _798 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_799, _79a, _79b) {
            var _79c = [];
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        singleSelect: true, remoteSort: false, fitColumns: true, loadMsg: "", frozenColumns: [[{ field: "f", width: 16, resizable: false }]], columns: [[{ field: "name", title: "Name", width: 100, sortable: true }, { field: "value", title: "Value", width: 100, resizable: false }]], showGroup: false, groupView: _798, groupField: "group", groupFormatter: function (_7bf, rows) {
            return _7bf;
        }
    });
})(jQuery);
(function ($) {
    function _7c0(_7c1) {
        ...
        if (opts.pagination) {
            ...
            _7d6.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_7d7, _7d8) {
    ...
    var _852 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_853, _854, _855) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, lines: false, animate: false, singleSelect: true, view: _852, loader: function (_88f, _890, _891) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _88f, dataType: "json", success: function (data) {
                    _890(data);
                }, error: function () {
            ...
            getTr: function (_893, id, type, _894) {
                type = type || "body";
                _894 = _894 || 0;
...
(function ($) {
    function _89b(_89c) {
        ...
        if (!_89d.panel) {
            ...
            _89d.panel.panel({
                minWidth: opts.panelMinWidth, maxWidth: opts.panelMaxWidth, minHeight: opts.panelMinHeight, maxHeight: opts.panelMaxHeight, doSize: false, closed: true, cls: "combo-p", style: { position: "absolute", zIndex: 10 }, onOpen: function () {
                    ...
                    if (_89e) {
                        _89e.options.onShowPanel.call(_89c);
                    }
                }, onBeforeClose: function () {
                    _8a8(this);
                }, onClose: function () {
                    var _89f = $.data(_89c, "combo");
                    if (_89f) {
                        _89f.options.onHidePanel.call(_89c);
                    }
                }
            });
        }
        var _8a0 = $.extend(true, [], opts.icons);
        ...
        $(_89c).addClass("combo-f").textbox($.extend({}, opts, {
            icons: _8a0, onChange: function () {
            }
        }));
    ...
    function _8a1(_8a2) {
        ...
        _8a3.panel.panel("destroy");
        $(_8a2).textbox("destroy");
    };
    function _8a4(_8a5) {
        var _8a6 = $.data(_8a5, "combo").panel;
        if (_8a6.is(":visible")) {
            _8a7(_8a5);
        } else {
            var p = $(_8a5).closest("div.combo-panel");
            $("div.combo-panel:visible").not(_8a6).not(p).panel("close");
            $(_8a5).combo("showPanel");
        }
        $(_8a5).combo("textbox").focus();
    };
    function _8a8(_8a9) {
        $(_8a9).find(".combo-f").each(function () {
    ...
    function _8ac(e) {
        var _8ad = e.data.target;
        var _8ae = $.data(_8ad, "combo");
        var opts = _8ae.options;
        var _8af = _8ae.panel;
        if (!opts.editable) {
            _8a4(_8ad);
        } else {
            var p = $(_8ad).closest("div.combo-panel");
            $("div.combo-panel:visible").not(_8af).not(p).panel("close");
        }
    };
    function _8b0(e) {
        var _8b1 = e.data.target;
        var t = $(_8b1);
        var _8b2 = t.data("combo");
        var opts = t.combo("options");
        switch (e.keyCode) {
            case 38:
                opts.keyHandler.up.call(_8b1, e);
                break;
            case 40:
                opts.keyHandler.down.call(_8b1, e);
                break;
            case 37:
                opts.keyHandler.left.call(_8b1, e);
                break;
            case 39:
                opts.keyHandler.right.call(_8b1, e);
                break;
            case 13:
                e.preventDefault();
                opts.keyHandler.enter.call(_8b1, e);
                return false;
            case 9:
            case 27:
                _8a7(_8b1);
            ...
            default:
                if (opts.editable) {
                    if (_8b2.timer) {
                        clearTimeout(_8b2.timer);
                    }
                    _8b2.timer = setTimeout(function () {
                        var q = t.combo("getText");
                        if (_8b2.previousText != q) {
                            _8b2.previousText = q;
                            t.combo("showPanel");
                            opts.keyHandler.query.call(_8b1, q, e);
                            t.combo("validate");
                        }
                    }, opts.delay);
                }
    ...
    function _8b3(_8b4) {
        ...
        var _8b6 = _8b5.combo;
        var _8b7 = _8b5.panel;
        var opts = $(_8b4).combo("options");
        if (_8b7.panel("options").closed) {
            _8b7.panel("panel").show().css({ zIndex: ($.fn.menu ? $.fn.menu.defaults.zIndex++ : $.fn.window.defaults.zIndex++), left: -999999 });
            _8b7.panel("resize", { width: (opts.panelWidth ? opts.panelWidth : _8b6._outerWidth()), height: opts.panelHeight });
            _8b7.panel("panel").hide();
            _8b7.panel("open");
        }
        (function () {
            if (_8b7.is(":visible")) {
                _8b7.panel("move", { left: _8b8(), top: _8b9() });
                setTimeout(arguments.callee, 200);
            }
        })();
        function _8b8() {
            var left = _8b6.offset().left;
            if (opts.panelAlign == "right") {
                left += _8b6._outerWidth() - _8b7._outerWidth();
            }
            if (left + _8b7._outerWidth() > $(window)._outerWidth() + $(document).scrollLeft()) {
                left = $(window)._outerWidth() + $(document).scrollLeft() - _8b7._outerWidth();
            }
            if (left < 0) {
                left = 0;
            }
        ...
        function _8b9() {
            var top = _8b6.offset().top + _8b6._outerHeight();
            if (top + _8b7._outerHeight() > $(window)._outerHeight() + $(document).scrollTop()) {
                top = _8b6.offset().top - _8b7._outerHeight();
            }
            if (top < $(document).scrollTop()) {
                top = _8b6.offset().top + _8b6._outerHeight();
            }
            return top;
        };
    };
    function _8a7(_8ba) {
        var _8bb = $.data(_8ba, "combo").panel;
        _8bb.panel("close");
    };
    function _8bc(_8bd) {
        var _8be = $.data(_8bd, "combo");
        ...
        if (opts.multiple) {
            ...
            _8bf.find(".textbox-value").val("");
        }
    };
    function _8c0(_8c1, text) {
        var _8c2 = $.data(_8c1, "combo");
        var _8c3 = $(_8c1).textbox("getText");
        if (_8c3 != text) {
            $(_8c1).textbox("setText", text);
            _8c2.previousText = text;
        }
    };
    function _8c4(_8c5) {
        var _8c6 = [];
        var _8c7 = $.data(_8c5, "combo").combo;
        _8c7.find(".textbox-value").each(function () {
            _8c6.push($(this).val());
        });
        return _8c6;
    };
    function _8c8(_8c9, _8ca) {
        ...
        var _8cb = $.data(_8c9, "combo");
        var opts = _8cb.options;
        var _8cc = _8cb.combo;
        var _8cd = _8c4(_8c9);
        _8cc.find(".textbox-value").remove();
        var name = $(_8c9).attr("textboxName") || "";
        for (var i = 0; i < _8ca.length; i++) {
            var _8ce = $("<input type=\"hidden\" class=\"textbox-value\">").appendTo(_8cc);
            _8ce.attr("name", name);
            if (opts.disabled) {
                _8ce.attr("disabled", "disabled");
            }
            _8ce.val(_8ca[i]);
        }
        var _8cf = (function () {
            if (_8cd.length != _8ca.length) {
                return true;
            }
            var a1 = $.extend(true, [], _8cd);
            var a2 = $.extend(true, [], _8ca);
            a1.sort();
            a2.sort();
        ...
        if (_8cf) {
            if (opts.multiple) {
                opts.onChange.call(_8c9, _8ca, _8cd);
            } else {
                opts.onChange.call(_8c9, _8ca[0], _8cd[0]);
            }
        }
    };
    function _8d0(_8d1) {
    ...
    function _8d6(_8d7) {
        var opts = $.data(_8d7, "combo").options;
        var _8d8 = opts.onChange;
        opts.onChange = function () {
        };
        if (opts.multiple) {
            _8c8(_8d7, opts.value ? opts.value : []);
        } else {
            _8d3(_8d7, opts.value);
        }
        opts.onChange = _8d8;
    };
    $.fn.combo = function (_8d9, _8da) {
        if (typeof _8d9 == "string") {
            var _8db = $.fn.combo.methods[_8d9];
            if (_8db) {
                return _8db(this, _8da);
            } else {
                return this.textbox(_8d9, _8da);
            }
        }
        _8d9 = _8d9 || {};
        return this.each(function () {
            var _8dc = $.data(this, "combo");
            if (_8dc) {
                $.extend(_8dc.options, _8d9);
                if (_8d9.value != undefined) {
                    _8dc.options.originalValue = _8d9.value;
                }
            } else {
                _8dc = $.data(this, "combo", { options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _8d9), previousText: "" });
                _8dc.options.originalValue = _8dc.options.value;
            }
            _89b(this);
            _8aa(this);
            _8d6(this);
    ...
    $.fn.combo.parseOptions = function (_8df) {
        var t = $(_8df);
        return $.extend({}, $.fn.textbox.parseOptions(_8df), $.parser.parseOptions(_8df, ["separator", "panelAlign", { panelWidth: "number", hasDownArrow: "boolean", delay: "number", selectOnNavigation: "boolean" }, { panelMinWidth: "number", panelMaxWidth: "number", panelMinHeight: "number", panelMaxHeight: "number" }]), { panelHeight: (t.attr("panelHeight") == "auto" ? "auto" : parseInt(t.attr("panelHeight")) || undefined), multiple: (t.attr("multiple") ? true : undefined) });
    };
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _8ac, keydown: _8b0, paste: _8b0, drop: _8b0 }, panelWidth: null, panelHeight: 200, panelMinWidth: null, panelMaxWidth: null, panelMinHeight: null, panelMaxHeight: null, panelAlign: "left", multiple: false, selectOnNavigation: true, separator: ",", hasDownArrow: true, delay: 200, keyHandler: {
            up: function (e) {
            }, down: function (e) {
            }, left: function (e) {
            }, right: function (e) {
...
(function ($) {
    ...
    function _8e3(_8e4, _8e5) {
        var _8e6 = $.data(_8e4, "combobox");
        var opts = _8e6.options;
        var data = _8e6.data;
        for (var i = 0; i < data.length; i++) {
            if (data[i][opts.valueField] == _8e5) {
                return i;
            }
        }
        return -1;
    ...
    function _8e7(_8e8, _8e9) {
        ...
        var _8ea = $(_8e8).combo("panel");
        var item = opts.finder.getEl(_8e8, _8e9);
        if (item.length) {
            if (item.position().top <= 0) {
                var h = _8ea.scrollTop() + item.position().top;
                _8ea.scrollTop(h);
            } else {
                if (item.position().top + item.outerHeight() > _8ea.height()) {
                    var h = _8ea.scrollTop() + item.position().top + item.outerHeight() - _8ea.height();
                    _8ea.scrollTop(h);
                }
            }
        }
    ...
    function nav(_8eb, dir) {
        ...
        var _8ec = $(_8eb).combobox("panel");
        var item = _8ec.children("div.combobox-item-hover");
        if (!item.length) {
            item = _8ec.children("div.combobox-item-selected");
        }
        item.removeClass("combobox-item-hover");
        var _8ed = "div.combobox-item:visible:not(.combobox-item-disabled):first";
        var _8ee = "div.combobox-item:visible:not(.combobox-item-disabled):last";
        if (!item.length) {
            item = _8ec.children(dir == "next" ? _8ed : _8ee);
        } else {
            if (dir == "next") {
                item = item.nextAll(_8ed);
                if (!item.length) {
                    item = _8ec.children(_8ed);
                }
            } else {
                item = item.prevAll(_8ed);
                if (!item.length) {
                    item = _8ec.children(_8ee);
                }
            }
        }
        if (item.length) {
            item.addClass("combobox-item-hover");
            var row = opts.finder.getRow(_8eb, item);
            if (row) {
                _8e7(_8eb, row[opts.valueField]);
                if (opts.selectOnNavigation) {
                    _8ef(_8eb, row[opts.valueField]);
                }
            }
        }
    };
    function _8ef(_8f0, _8f1) {
        var opts = $.data(_8f0, "combobox").options;
        var _8f2 = $(_8f0).combo("getValues");
        if ($.inArray(_8f1 + "", _8f2) == -1) {
            if (opts.multiple) {
                _8f2.push(_8f1);
            } else {
                _8f2 = [_8f1];
            ...
            _8f3(_8f0, _8f2);
            opts.onSelect.call(_8f0, opts.finder.getRow(_8f0, _8f1));
        }
    };
    function _8f4(_8f5, _8f6) {
        var opts = $.data(_8f5, "combobox").options;
        var _8f7 = $(_8f5).combo("getValues");
        var _8f8 = $.inArray(_8f6 + "", _8f7);
        if (_8f8 >= 0) {
            _8f7.splice(_8f8, 1);
            _8f3(_8f5, _8f7);
            opts.onUnselect.call(_8f5, opts.finder.getRow(_8f5, _8f6));
        }
    };
    function _8f3(_8f9, _8fa, _8fb) {
        var opts = $.data(_8f9, "combobox").options;
        var _8fc = $(_8f9).combo("panel");
        _8fc.find("div.combobox-item-selected").removeClass("combobox-item-selected");
        var vv = [], ss = [];
        for (var i = 0; i < _8fa.length; i++) {
            var v = _8fa[i];
            var s = v;
            opts.finder.getEl(_8f9, v).addClass("combobox-item-selected");
            var row = opts.finder.getRow(_8f9, v);
            if (row) {
        ...
        $(_8f9).combo("setValues", vv);
        if (!_8fb) {
            $(_8f9).combo("setText", ss.join(opts.separator));
        }
    };
    function _8fd(_8fe, data, _8ff) {
        var _900 = $.data(_8fe, "combobox");
        var opts = _900.options;
        _900.data = opts.loadFilter.call(_8fe, data);
        _900.groups = [];
        data = _900.data;
        var _901 = $(_8fe).combobox("getValues");
        var dd = [];
        var _902 = undefined;
        for (var i = 0; i < data.length; i++) {
            var row = data[i];
            ...
            if (g) {
                if (_902 != g) {
                    _902 = g;
                    _900.groups.push(g);
                    dd.push("<div id=\"" + (_900.groupIdPrefix + "_" + (_900.groups.length - 1)) + "\" class=\"combobox-group\">");
                    dd.push(opts.groupFormatter ? opts.groupFormatter.call(_8fe, g) : g);
                    dd.push("</div>");
                }
            } else {
                _902 = undefined;
            ...
            dd.push("<div id=\"" + (_900.itemIdPrefix + "_" + i) + "\" class=\"" + cls + "\">");
            dd.push(opts.formatter ? opts.formatter.call(_8fe, row) : s);
            dd.push("</div>");
            if (row["selected"] && $.inArray(v, _901) == -1) {
                _901.push(v);
            }
        }
        $(_8fe).combo("panel").html(dd.join(""));
        if (opts.multiple) {
            _8f3(_8fe, _901, _8ff);
        } else {
            _8f3(_8fe, _901.length ? [_901[_901.length - 1]] : [], _8ff);
        }
        opts.onLoadSuccess.call(_8fe, data);
    };
    function _903(_904, url, _905, _906) {
        var opts = $.data(_904, "combobox").options;
        if (url) {
            opts.url = url;
        }
        _905 = _905 || {};
        if (opts.onBeforeLoad.call(_904, _905) == false) {
            return;
        }
        opts.loader.call(_904, _905, function (data) {
            _8fd(_904, data, _906);
        }, function () {
            opts.onLoadError.apply(this, arguments);
        });
    };
    function _907(_908, q) {
        var _909 = $.data(_908, "combobox");
        ...
        if (opts.mode == "remote") {
            _903(_908, null, { q: q }, true);
        } else {
            var _90a = $(_908).combo("panel");
            _90a.find("div.combobox-item-selected,div.combobox-item-hover").removeClass("combobox-item-selected combobox-item-hover");
            _90a.find("div.combobox-item,div.combobox-group").hide();
            var data = _909.data;
            var vv = [];
            ...
            $.map(qq, function (q) {
                ...
                for (var i = 0; i < data.length; i++) {
                    var row = data[i];
                    if (opts.filter.call(_908, q, row)) {
                        var v = row[opts.valueField];
                        var s = row[opts.textField];
                        var g = row[opts.groupField];
                        var item = opts.finder.getEl(_908, v).show();
                        if (s.toLowerCase() == q.toLowerCase()) {
                            vv.push(v);
                            item.addClass("combobox-item-selected");
                        }
                        if (opts.groupField && _90b != g) {
                            $("#" + _909.groupIdPrefix + "_" + $.inArray(g, _909.groups)).show();
                            _90b = g;
                        }
                    }
                }
    ...
    function _90c(_90d) {
        ...
        var _90e = t.combobox("panel");
        var item = _90e.children("div.combobox-item-hover");
        if (item.length) {
            var row = opts.finder.getRow(_90d, item);
            var _90f = row[opts.valueField];
            if (opts.multiple) {
                if (item.hasClass("combobox-item-selected")) {
                    t.combobox("unselect", _90f);
                } else {
                    t.combobox("select", _90f);
                }
            } else {
                t.combobox("select", _90f);
            }
    ...
    function _910(_911) {
        var _912 = $.data(_911, "combobox");
        var opts = _912.options;
        _8e2++;
        _912.itemIdPrefix = "_easyui_combobox_i" + _8e2;
        _912.groupIdPrefix = "_easyui_combobox_g" + _8e2;
        $(_911).addClass("combobox-f");
        $(_911).combo($.extend({}, opts, {
            onShowPanel: function () {
                $(_911).combo("panel").find("div.combobox-item,div.combobox-group").show();
                _8e7(_911, $(_911).combobox("getValue"));
                opts.onShowPanel.call(_911);
            }
        }));
        $(_911).combo("panel").unbind().bind("mouseover", function (e) {
            ...
            var row = opts.finder.getRow(_911, item);
            if (!row) {
                return;
            }
            var _913 = row[opts.valueField];
            if (opts.multiple) {
                if (item.hasClass("combobox-item-selected")) {
                    _8f4(_911, _913);
                } else {
    ...
    $.fn.combobox = function (_914, _915) {
        if (typeof _914 == "string") {
            var _916 = $.fn.combobox.methods[_914];
            if (_916) {
        ...
        _914 = _914 || {};
        return this.each(function () {
            var _917 = $.data(this, "combobox");
            if (_917) {
                $.extend(_917.options, _914);
                _910(this);
            } else {
                _917 = $.data(this, "combobox", { options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _914), data: [] });
                _910(this);
            ...
            if (_917.options.data) {
                _8fd(this, _917.options.data);
            }
            _903(this);
        });
    };
    $.fn.combobox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combobox").options, { width: _918.width, height: _918.height, originalValue: _918.originalValue, disabled: _918.disabled, readonly: _918.readonly });
        }, getData: function (jq) {
            ...
            return jq.each(function () {
                $(this).combo("clear");
                var _91b = $(this).combo("panel");
                _91b.find("div.combobox-item-selected").removeClass("combobox-item-selected");
            });
        }, reset: function (jq) {
            return jq.each(function () {
        ...
        }, select: function (jq, _91c) {
            return jq.each(function () {
                _8ef(this, _91c);
            });
        }, unselect: function (jq, _91d) {
            return jq.each(function () {
                _8f4(this, _91d);
            });
        }
    };
    $.fn.combobox.parseOptions = function (_91e) {
        var t = $(_91e);
        return $.extend({}, $.fn.combo.parseOptions(_91e), $.parser.parseOptions(_91e, ["valueField", "textField", "groupField", "mode", "method", "url"]));
    };
    $.fn.combobox.parseData = function (_91f) {
        var data = [];
        var opts = $(_91f).combobox("options");
        $(_91f).children().each(function () {
            if (this.tagName.toLowerCase() == "optgroup") {
                var _920 = $(this).attr("label");
        ...
        function _921(el, _922) {
            ...
            if (_922) {
                ...
                row[opts.groupField] = _922;
            }
            data.push(row);
        };
    };
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupField: null, groupFormatter: function (_923) {
            return _923;
        ...
        }, loader: function (_924, _925, _926) {
            var opts = $(this).combobox("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _924, dataType: "json", success: function (data) {
                    _925(data);
                }, error: function () {
                    _926.apply(this, arguments);
                }
            });
        }, loadFilter: function (data) {
            return data;
        }, finder: {
            getEl: function (_927, _928) {
                var _929 = _8e3(_927, _928);
                var id = $.data(_927, "combobox").itemIdPrefix + "_" + _929;
                return $("#" + id);
            }, getRow: function (_92a, p) {
                var _92b = $.data(_92a, "combobox");
                var _92c = (p instanceof jQuery) ? p.attr("id").substr(_92b.itemIdPrefix.length + 1) : _8e3(_92a, p);
                return _92b.data[parseInt(_92c)];
            }
        }, onBeforeLoad: function (_92d) {
        }, onLoadSuccess: function () {
        }, onLoadError: function () {
        }, onSelect: function (_92e) {
        }, onUnselect: function (_92f) {
        }
    });
})(jQuery);
(function ($) {
    function _930(_931) {
        ...
        var tree = _932.tree;
        $(_931).addClass("combotree-f");
        $(_931).combo(opts);
        var _933 = $(_931).combo("panel");
        if (!tree) {
            tree = $("<ul></ul>").appendTo(_933);
            $.data(_931, "combotree").tree = tree;
        }
        tree.tree($.extend({}, opts, {
            checkbox: opts.multiple, onLoadSuccess: function (node, data) {
                var _934 = $(_931).combotree("getValues");
                if (opts.multiple) {
                ...
                var _936 = $(this).tree("options");
                var _937 = _936.onCheck;
                var _938 = _936.onSelect;
                _936.onCheck = _936.onSelect = function () {
                };
                $(_931).combotree("setValues", _934);
                _936.onCheck = _937;
                _936.onSelect = _938;
                ...
                if (opts.multiple) {
                    ...
                    $(_931).combo("hidePanel");
                }
                _93a(_931);
                opts.onClick.call(this, node);
            }, onCheck: function (node, _939) {
                _93a(_931);
                opts.onCheck.call(this, node, _939);
            }
        }));
    };
    function _93a(_93b) {
        var _93c = $.data(_93b, "combotree");
        var opts = _93c.options;
        var tree = _93c.tree;
        var vv = [], ss = [];
        if (opts.multiple) {
            var _93d = tree.tree("getChecked");
        ...
        $(_93b).combo("setValues", vv).combo("setText", ss.join(opts.separator));
    };
    function _93e(_93f, _940) {
        var opts = $.data(_93f, "combotree").options;
        var tree = $.data(_93f, "combotree").tree;
        ...
        $(_93f).combo("setValues", vv).combo("setText", ss.join(opts.separator));
    };
    $.fn.combotree = function (_941, _942) {
        if (typeof _941 == "string") {
            var _943 = $.fn.combotree.methods[_941];
            if (_943) {
        ...
        _941 = _941 || {};
        return this.each(function () {
            var _944 = $.data(this, "combotree");
            if (_944) {
                $.extend(_944.options, _941);
            } else {
                $.data(this, "combotree", { options: $.extend({}, $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _941) });
            }
            _930(this);
        });
    };
    $.fn.combotree.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combotree").options, { width: _945.width, height: _945.height, originalValue: _945.originalValue, disabled: _945.disabled, readonly: _945.readonly });
        }, tree: function (jq) {
    ...
    $.fn.combotree.parseOptions = function (_948) {
        return $.extend({}, $.fn.combo.parseOptions(_948), $.fn.tree.parseOptions(_948));
    };
...
(function ($) {
    function _949(_94a) {
        ...
        var grid = _94b.grid;
        $(_94a).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                var p = $(this).combogrid("panel");
                var _94c = p.outerHeight() - p.height();
                var _94d = p._size("minHeight");
                var _94e = p._size("maxHeight");
                $(this).combogrid("grid").datagrid("resize", { width: "100%", height: (isNaN(parseInt(opts.panelHeight)) ? "auto" : "100%"), minHeight: (_94d ? _94d - _94c : ""), maxHeight: (_94e ? _94e - _94c : "") });
                opts.onShowPanel.call(this);
            }
        }));
        var _94f = $(_94a).combo("panel");
        if (!grid) {
            grid = $("<table></table>").appendTo(_94f);
            _94b.grid = grid;
        }
        grid.datagrid($.extend({}, opts, {
            border: false, singleSelect: (!opts.multiple), onLoadSuccess: function (data) {
                var _950 = $(_94a).combo("getValues");
                var _951 = opts.onSelect;
                opts.onSelect = function () {
                };
                _95b(_94a, _950, _94b.remainText);
                opts.onSelect = _951;
                opts.onLoadSuccess.apply(_94a, arguments);
            }, onClickRow: _952, onSelect: function (_953, row) {
                _954();
                opts.onSelect.call(this, _953, row);
            }, onUnselect: function (_955, row) {
                _954();
                opts.onUnselect.call(this, _955, row);
            }, onSelectAll: function (rows) {
                _954();
        ...
        function _952(_956, row) {
            _94b.remainText = false;
            _954();
            if (!opts.multiple) {
                $(_94a).combo("hidePanel");
            }
            opts.onClickRow.call(this, _956, row);
        };
        function _954() {
            ...
            if (!opts.multiple) {
                $(_94a).combo("setValues", (vv.length ? vv : [""]));
            } else {
                $(_94a).combo("setValues", vv);
            }
            if (!_94b.remainText) {
                $(_94a).combo("setText", ss.join(opts.separator));
            }
        };
    };
    function nav(_957, dir) {
        var _958 = $.data(_957, "combogrid");
        var opts = _958.options;
        var grid = _958.grid;
        var _959 = grid.datagrid("getRows").length;
        if (!_959) {
            return;
        }
        ...
        var _95a;
        if (!tr.length) {
            _95a = (dir == "next" ? 0 : _959 - 1);
        } else {
            var _95a = parseInt(tr.attr("datagrid-row-index"));
            _95a += (dir == "next" ? 1 : -1);
            if (_95a < 0) {
                _95a = _959 - 1;
            }
        ...
        grid.datagrid("highlightRow", _95a);
        if (opts.selectOnNavigation) {
            _958.remainText = false;
            grid.datagrid("selectRow", _95a);
        }
    };
    function _95b(_95c, _95d, _95e) {
        var _95f = $.data(_95c, "combogrid");
        var opts = _95f.options;
        var grid = _95f.grid;
        var rows = grid.datagrid("getRows");
        var ss = [];
        var _960 = $(_95c).combo("getValues");
        var _961 = $(_95c).combo("options");
        var _962 = _961.onChange;
        _961.onChange = function () {
        };
        grid.datagrid("clearSelections");
        for (var i = 0; i < _95d.length; i++) {
            var _963 = grid.datagrid("getRowIndex", _95d[i]);
            if (_963 >= 0) {
                grid.datagrid("selectRow", _963);
                ss.push(rows[_963][opts.textField]);
            } else {
                ss.push(_95d[i]);
            }
        }
        $(_95c).combo("setValues", _960);
        _961.onChange = _962;
        $(_95c).combo("setValues", _95d);
        if (!_95e) {
            var s = ss.join(opts.separator);
            if ($(_95c).combo("getText") != s) {
                $(_95c).combo("setText", s);
            }
        }
    };
    function _964(_965, q) {
        var _966 = $.data(_965, "combogrid");
        var opts = _966.options;
        var grid = _966.grid;
        _966.remainText = true;
        if (opts.multiple && !q) {
            _95b(_965, [], true);
        } else {
            _95b(_965, [q], true);
                ...
                if (q) {
                    $.map(rows, function (row, i) {
                        if (q == row[opts.textField]) {
                            ...
                            if (opts.filter.call(_965, q, row)) {
    ...
    function _967(_968) {
        var _969 = $.data(_968, "combogrid");
        var opts = _969.options;
        var grid = _969.grid;
        var tr = opts.finder.getTr(grid[0], null, "highlight");
        _969.remainText = false;
        if (tr.length) {
            var _96a = parseInt(tr.attr("datagrid-row-index"));
            if (opts.multiple) {
                if (tr.hasClass("datagrid-row-selected")) {
                    grid.datagrid("unselectRow", _96a);
                } else {
                    grid.datagrid("selectRow", _96a);
                }
            } else {
                grid.datagrid("selectRow", _96a);
            }
        ...
        $(_968).combogrid("setValues", vv);
        if (!opts.multiple) {
            $(_968).combogrid("hidePanel");
        }
    };
    $.fn.combogrid = function (_96b, _96c) {
        if (typeof _96b == "string") {
            var _96d = $.fn.combogrid.methods[_96b];
            if (_96d) {
                return _96d(this, _96c);
            } else {
                return this.combo(_96b, _96c);
            }
        }
        _96b = _96b || {};
        return this.each(function () {
            var _96e = $.data(this, "combogrid");
            if (_96e) {
                $.extend(_96e.options, _96b);
            } else {
                _96e = $.data(this, "combogrid", { options: $.extend({}, $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _96b) });
            }
            _949(this);
        });
    };
    $.fn.combogrid.methods = {
        options: function (jq) {
            var _96f = jq.combo("options");
            return $.extend($.data(jq[0], "combogrid").options, { width: _96f.width, height: _96f.height, originalValue: _96f.originalValue, disabled: _96f.disabled, readonly: _96f.readonly });
        }, grid: function (jq) {
            return $.data(jq[0], "combogrid").grid;
        }, setValues: function (jq, _970) {
            return jq.each(function () {
                _95b(this, _970);
            });
    ...
    $.fn.combogrid.parseOptions = function (_972) {
        var t = $(_972);
        return $.extend({}, $.fn.combo.parseOptions(_972), $.fn.datagrid.parseOptions(_972), $.parser.parseOptions(_972, ["idField", "textField", "mode"]));
    };
...
(function ($) {
    function _973(_974) {
        var _975 = $.data(_974, "datebox");
        var opts = _975.options;
        $(_974).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _976();
                _97e(_974, $(_974).datebox("getText"), true);
                opts.onShowPanel.call(_974);
            }
        }));
        $(_974).combo("textbox").parent().addClass("datebox");
        if (!_975.calendar) {
            _977();
        }
        _97e(_974, opts.value);
        function _977() {
            var _978 = $(_974).combo("panel").css("overflow", "hidden");
            _978.panel("options").onBeforeDestroy = function () {
                var sc = $(this).find(".calendar-shared");
                if (sc.length) {
                    sc.insertBefore(sc[0].pholder);
                }
            };
            var cc = $("<div class=\"datebox-calendar-inner\"></div>").appendTo(_978);
            if (opts.sharedCalendar) {
                ...
                _975.calendar = $("<div></div>").appendTo(cc).calendar();
            }
            $.extend(_975.calendar.calendar("options"), {
                fit: true, border: false, onSelect: function (date) {
                    var opts = $(this.target).datebox("options");
                    _97e(this.target, opts.formatter.call(this.target, date));
                    $(this.target).combo("hidePanel");
                    opts.onSelect.call(_974, date);
                }
            });
            var _979 = $("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_978);
            var tr = _979.find("tr");
            for (var i = 0; i < opts.buttons.length; i++) {
                var td = $("<td></td>").appendTo(tr);
                var btn = opts.buttons[i];
                var t = $("<a href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text) ? btn.text(_974) : btn.text).appendTo(td);
                t.bind("click", { target: _974, handler: btn.handler }, function (e) {
        ...
        function _976() {
            var _97a = $(_974).combo("panel");
            var cc = _97a.children("div.datebox-calendar-inner");
            _97a.children()._outerWidth(_97a.width());
            _975.calendar.appendTo(cc);
            _975.calendar[0].target = _974;
            if (opts.panelHeight != "auto") {
                var _97b = _97a.height();
                _97a.children().not(cc).each(function () {
                    _97b -= $(this).outerHeight();
                });
                cc._outerHeight(_97b);
            }
            _975.calendar.calendar("resize");
        };
    };
    ...
    function _97f(_980) {
        var _981 = $.data(_980, "datebox");
        var opts = _981.options;
        var _982 = _981.calendar.calendar("options").current;
        if (_982) {
            _97e(_980, opts.formatter.call(_980, _982));
            $(_980).combo("hidePanel");
        }
    };
    function _97e(_983, _984, _985) {
        var _986 = $.data(_983, "datebox");
        var opts = _986.options;
        var _987 = _986.calendar;
        $(_983).combo("setValue", _984);
        _987.calendar("moveTo", opts.parser.call(_983, _984));
        if (!_985) {
            if (_984) {
                _984 = opts.formatter.call(_983, _987.calendar("options").current);
                $(_983).combo("setValue", _984).combo("setText", _984);
            } else {
                $(_983).combo("setText", _984);
            }
        }
    };
    $.fn.datebox = function (_988, _989) {
        if (typeof _988 == "string") {
            var _98a = $.fn.datebox.methods[_988];
            if (_98a) {
                return _98a(this, _989);
            } else {
                return this.combo(_988, _989);
            }
        }
        _988 = _988 || {};
        return this.each(function () {
            var _98b = $.data(this, "datebox");
            if (_98b) {
                $.extend(_98b.options, _988);
            } else {
                $.data(this, "datebox", { options: $.extend({}, $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _988) });
            }
            _973(this);
        });
    };
    $.fn.datebox.methods = {
        options: function (jq) {
            var _98c = jq.combo("options");
            return $.extend($.data(jq[0], "datebox").options, { width: _98c.width, height: _98c.height, originalValue: _98c.originalValue, disabled: _98c.disabled, readonly: _98c.readonly });
        }, calendar: function (jq) {
            return $.data(jq[0], "datebox").calendar;
        }, setValue: function (jq, _98d) {
            return jq.each(function () {
                _97e(this, _98d);
            });
        }, reset: function (jq) {
    ...
    $.fn.datebox.parseOptions = function (_98e) {
        return $.extend({}, $.fn.combo.parseOptions(_98e), $.parser.parseOptions(_98e, ["sharedCalendar"]));
    };
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
        panelWidth: 180, panelHeight: "auto", sharedCalendar: null, keyHandler: {
            ...
            text: function (_98f) {
                return $(_98f).datebox("options").currentText;
            }, handler: function (_990) {
                $(_990).datebox("calendar").calendar({ year: new Date().getFullYear(), month: new Date().getMonth() + 1, current: new Date() });
                _97f(_990);
            }
        }, {
            text: function (_991) {
                return $(_991).datebox("options").closeText;
            }, handler: function (_992) {
...
(function ($) {
    function _993(_994) {
        var _995 = $.data(_994, "datetimebox");
        var opts = _995.options;
        $(_994).datebox($.extend({}, opts, {
            onShowPanel: function () {
                var _996 = $(_994).datetimebox("getValue");
                _998(_994, _996, true);
                opts.onShowPanel.call(_994);
            }, formatter: $.fn.datebox.defaults.formatter, parser: $.fn.datebox.defaults.parser
        }));
        $(_994).removeClass("datebox-f").addClass("datetimebox-f");
        $(_994).datebox("calendar").calendar({
            onSelect: function (date) {
                opts.onSelect.call(_994, date);
            }
        });
        var _997 = $(_994).datebox("panel");
        if (!_995.spinner) {
            var p = $("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_997.children("div.datebox-calendar-inner"));
            _995.spinner = p.children("input");
        }
        _995.spinner.timespinner({ width: opts.spinnerWidth, showSeconds: opts.showSeconds, separator: opts.timeSeparator }).unbind(".datetimebox").bind("mousedown.datetimebox", function (e) {
            e.stopPropagation();
        });
        _998(_994, opts.value);
    };
    function _999(_99a) {
        var c = $(_99a).datetimebox("calendar");
        var t = $(_99a).datetimebox("spinner");
    ...
    function _99d(_99e) {
        ...
        var date = _999(_99e);
        _998(_99e, opts.formatter.call(_99e, date));
        $(_99e).combo("hidePanel");
    };
    function _998(_99f, _9a0, _9a1) {
        var opts = $.data(_99f, "datetimebox").options;
        $(_99f).combo("setValue", _9a0);
        if (!_9a1) {
            if (_9a0) {
                var date = opts.parser.call(_99f, _9a0);
                $(_99f).combo("setValue", opts.formatter.call(_99f, date));
                $(_99f).combo("setText", opts.formatter.call(_99f, date));
            } else {
                $(_99f).combo("setText", _9a0);
            }
        }
        var date = opts.parser.call(_99f, _9a0);
        $(_99f).datetimebox("calendar").calendar("moveTo", date);
        $(_99f).datetimebox("spinner").timespinner("setValue", _9a2(date));
        function _9a2(date) {
            function _9a3(_9a4) {
                return (_9a4 < 10 ? "0" : "") + _9a4;
            };
            var tt = [_9a3(date.getHours()), _9a3(date.getMinutes())];
            if (opts.showSeconds) {
                tt.push(_9a3(date.getSeconds()));
            }
            return tt.join($(_99f).datetimebox("spinner").timespinner("options").separator);
        };
    };
    $.fn.datetimebox = function (_9a5, _9a6) {
        if (typeof _9a5 == "string") {
            var _9a7 = $.fn.datetimebox.methods[_9a5];
            if (_9a7) {
                return _9a7(this, _9a6);
            } else {
                return this.datebox(_9a5, _9a6);
            }
        }
        _9a5 = _9a5 || {};
        return this.each(function () {
            var _9a8 = $.data(this, "datetimebox");
            if (_9a8) {
                $.extend(_9a8.options, _9a5);
            } else {
                $.data(this, "datetimebox", { options: $.extend({}, $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _9a5) });
            }
            _993(this);
        });
    };
    $.fn.datetimebox.methods = {
        options: function (jq) {
            var _9a9 = jq.datebox("options");
            return $.extend($.data(jq[0], "datetimebox").options, { originalValue: _9a9.originalValue, disabled: _9a9.disabled, readonly: _9a9.readonly });
        }, spinner: function (jq) {
            return $.data(jq[0], "datetimebox").spinner;
        }, setValue: function (jq, _9aa) {
            return jq.each(function () {
                _998(this, _9aa);
            });
        }, reset: function (jq) {
    ...
    $.fn.datetimebox.parseOptions = function (_9ab) {
        var t = $(_9ab);
        return $.extend({}, $.fn.datebox.parseOptions(_9ab), $.parser.parseOptions(_9ab, ["timeSeparator", "spinnerWidth", { showSeconds: "boolean" }]));
    };
    $.fn.datetimebox.defaults = $.extend({}, $.fn.datebox.defaults, {
        spinnerWidth: "100%", showSeconds: true, timeSeparator: ":", keyHandler: {
            ...
            text: function (_9ac) {
                return $(_9ac).datetimebox("options").currentText;
            }, handler: function (_9ad) {
                $(_9ad).datetimebox("calendar").calendar({ year: new Date().getFullYear(), month: new Date().getMonth() + 1, current: new Date() });
                _99d(_9ad);
            }
        }, {
            text: function (_9ae) {
                return $(_9ae).datetimebox("options").okText;
            }, handler: function (_9af) {
                _99d(_9af);
            }
        }, {
            text: function (_9b0) {
                return $(_9b0).datetimebox("options").closeText;
            }, handler: function (_9b1) {
                $(this).closest("div.combo-panel").panel("close");
            }
        }], formatter: function (date) {
            var h = date.getHours();
            ...
            function _9b2(_9b3) {
                return (_9b3 < 10 ? "0" : "") + _9b3;
            };
            var _9b4 = $(this).datetimebox("spinner").timespinner("options").separator;
            var r = $.fn.datebox.defaults.formatter(date) + " " + _9b2(h) + _9b4 + _9b2(M);
            ...
            var tt = dt[1].split(_9b5);
            var hour = parseInt(tt[0], 10) || 0;
            var _9b6 = parseInt(tt[1], 10) || 0;
            var _9b7 = parseInt(tt[2], 10) || 0;
            return new Date(d.getFullYear(), d.getMonth(), d.getDate(), hour, _9b6, _9b7);
        }
    });
})(jQuery);
(function ($) {
    function init(_9b8) {
        var _9b9 = $("<div class=\"slider\">" + "<div class=\"slider-inner\">" + "<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>" + "<span class=\"slider-tip\"></span>" + "</div>" + "<div class=\"slider-rule\"></div>" + "<div class=\"slider-rulelabel\"></div>" + "<div style=\"clear:both\"></div>" + "<input type=\"hidden\" class=\"slider-value\">" + "</div>").insertAfter(_9b8);
        var t = $(_9b8);
        t.addClass("slider-f").hide();
        var name = t.attr("name");
        if (name) {
            _9b9.find("input.slider-value").attr("name", name);
            t.removeAttr("name").attr("sliderName", name);
        }
        _9b9.bind("_resize", function (e, _9ba) {
            if ($(this).hasClass("easyui-fluid") || _9ba) {
                _9bb(_9b8);
            }
            return false;
        });
    ...
    function _9bb(_9bc, _9bd) {
        var _9be = $.data(_9bc, "slider");
        var opts = _9be.options;
        var _9bf = _9be.slider;
        if (_9bd) {
            if (_9bd.width) {
                opts.width = _9bd.width;
            }
            if (_9bd.height) {
                opts.height = _9bd.height;
            }
        }
        _9bf._size(opts);
        if (opts.mode == "h") {
            _9bf.css("height", "");
            _9bf.children("div").css("height", "");
        } else {
            _9bf.css("width", "");
            _9bf.children("div").css("width", "");
            _9bf.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_9bf._outerHeight());
        }
        _9c0(_9bc);
    };
    function _9c1(_9c2) {
        ...
        _9c5(aa);
        function _9c5(aa) {
            var rule = _9c4.find("div.slider-rule");
            var _9c6 = _9c4.find("div.slider-rulelabel");
            rule.empty();
            _9c6.empty();
            for (var i = 0; i < aa.length; i++) {
                var _9c7 = i * 100 / (aa.length - 1) + "%";
                var span = $("<span></span>").appendTo(rule);
                span.css((opts.mode == "h" ? "left" : "top"), _9c7);
                if (aa[i] != "|") {
                    span = $("<span></span>").appendTo(_9c6);
                    span.html(aa[i]);
                    if (opts.mode == "h") {
                        span.css({ left: _9c7, marginLeft: -Math.round(span.outerWidth() / 2) });
                    } else {
                        span.css({ top: _9c7, marginTop: -Math.round(span.outerHeight() / 2) });
                    }
                }
            }
        };
    ...
    function _9c8(_9c9) {
        var _9ca = $.data(_9c9, "slider");
        var opts = _9ca.options;
        var _9cb = _9ca.slider;
        _9cb.removeClass("slider-h slider-v slider-disabled");
        _9cb.addClass(opts.mode == "h" ? "slider-h" : "slider-v");
        _9cb.addClass(opts.disabled ? "slider-disabled" : "");
        _9cb.find("a.slider-handle").draggable({
            axis: opts.mode, cursor: "pointer", disabled: opts.disabled, onDrag: function (e) {
                ...
                if (left < 0 || left > _9cc) {
                    ...
                    var _9cd = _9df(_9c9, left);
                    _9ce(_9cd);
                    return false;
                }
            }, onBeforeDrag: function () {
                _9ca.isDragging = true;
            }, onStartDrag: function () {
                opts.onSlideStart.call(_9c9, opts.value);
            }, onStopDrag: function (e) {
                var _9cf = _9df(_9c9, (opts.mode == "h" ? e.data.left : e.data.top));
                _9ce(_9cf);
                opts.onSlideEnd.call(_9c9, opts.value);
                opts.onComplete.call(_9c9, opts.value);
                _9ca.isDragging = false;
            }
        });
        _9cb.find("div.slider-inner").unbind(".slider").bind("mousedown.slider", function (e) {
            if (_9ca.isDragging || opts.disabled) {
                return;
            }
            var pos = $(this).offset();
            var _9d0 = _9df(_9c9, (opts.mode == "h" ? (e.pageX - pos.left) : (e.pageY - pos.top)));
            _9ce(_9d0);
            opts.onComplete.call(_9c9, opts.value);
        });
        function _9ce(_9d1) {
            var s = Math.abs(_9d1 % opts.step);
            if (s < opts.step / 2) {
                _9d1 -= s;
            } else {
                _9d1 = _9d1 - s + opts.step;
            }
            _9d2(_9c9, _9d1);
        };
    };
    function _9d2(_9d3, _9d4) {
        ...
        opts.value = _9d4;
        $(_9d3).val(_9d4);
        _9d6.find("input.slider-value").val(_9d4);
        var pos = _9d8(_9d3, _9d4);
        var tip = _9d6.find(".slider-tip");
        if (opts.showTip) {
            tip.show();
            tip.html(opts.tipFormatter.call(_9d3, opts.value));
        } else {
            tip.hide();
        }
        if (opts.mode == "h") {
            var _9d9 = "left:" + pos + "px;";
            _9d6.find(".slider-handle").attr("style", _9d9);
            tip.attr("style", _9d9 + "margin-left:" + (-Math.round(tip.outerWidth() / 2)) + "px");
        } else {
            var _9d9 = "top:" + pos + "px;";
            _9d6.find(".slider-handle").attr("style", _9d9);
            tip.attr("style", _9d9 + "margin-left:" + (-Math.round(tip.outerWidth())) + "px");
        }
        if (_9d7 != _9d4) {
            opts.onChange.call(_9d3, _9d4, _9d7);
        }
    };
    function _9c0(_9da) {
        var opts = $.data(_9da, "slider").options;
        var fn = opts.onChange;
        opts.onChange = function () {
        };
        _9d2(_9da, opts.value);
        opts.onChange = fn;
    };
    function _9d8(_9db, _9dc) {
        var _9dd = $.data(_9db, "slider");
        var opts = _9dd.options;
        var _9de = _9dd.slider;
        var size = opts.mode == "h" ? _9de.width() : _9de.height();
        var pos = opts.converter.toPosition.call(_9db, _9dc, size);
        if (opts.mode == "v") {
            pos = _9de.height() - pos;
        }
        if (opts.reversed) {
    ...
    function _9df(_9e0, pos) {
        var _9e1 = $.data(_9e0, "slider");
        var opts = _9e1.options;
        var _9e2 = _9e1.slider;
        var size = opts.mode == "h" ? _9e2.width() : _9e2.height();
        var _9e3 = opts.converter.toValue.call(_9e0, opts.mode == "h" ? (opts.reversed ? (size - pos) : pos) : (size - pos), size);
        return _9e3.toFixed(0);
    };
    $.fn.slider = function (_9e4, _9e5) {
        if (typeof _9e4 == "string") {
            return $.fn.slider.methods[_9e4](this, _9e5);
        }
        _9e4 = _9e4 || {};
        return this.each(function () {
            var _9e6 = $.data(this, "slider");
            if (_9e6) {
                $.extend(_9e6.options, _9e4);
            } else {
                _9e6 = $.data(this, "slider", { options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _9e4), slider: init(this) });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function (_9e9) {
        var t = $(_9e9);
        return $.extend({}, $.parser.parseOptions(_9e9, ["width", "height", "mode", { reversed: "boolean", showTip: "boolean", min: "number", max: "number", step: "number" }]), { value: (t.val() || undefined), disabled: (t.attr("disabled") ? true : undefined), rule: (t.attr("rule") ? eval(t.attr("rule")) : undefined) });
    };
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, value: 0, min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_9ea) {
            return _9ea;
        }, converter: {
            toPosition: function (_9eb, size) {
                var opts = $(this).slider("options");
                return (_9eb - opts.min) / (opts.max - opts.min) * size;
            }, toValue: function (pos, size) {
                var opts = $(this).slider("options");
                return opts.min + (opts.max - opts.min) * (pos / size);
            }
        }, onChange: function (_9ec, _9ed) {
        }, onSlideStart: function (_9ee) {
        }, onSlideEnd: function (_9ef) {
        }, onComplete: function (_9f0) {
        }
    };
})(jQuery);
