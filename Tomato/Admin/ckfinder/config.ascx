...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		Thumbnails.MaxWidth = 360;
		Thumbnails.MaxHeight = 360;
	    ...
	    //if (user.Role == 1)
	    {
            ...
            type.MaxSize = 0;
            type.AllowedExtensions = allowImageExts;
            type.DeniedExtensions = new string[] { };

            /*type = ResourceType.Add("User");
            type.Url = BaseUrl + "user/";
            type.Dir = BaseDir == "" ? "" : BaseDir + "user/";
            type.MaxSize = 0;
